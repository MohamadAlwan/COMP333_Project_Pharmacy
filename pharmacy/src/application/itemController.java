...
public class itemController {
	...
	void addOnAction(ActionEvent event) {
		...
		try {
			...
			rc = new Item(addName.getText(), Integer.parseInt(addParcode.getText()),
					...
					AddCompanyName.getText(), Integer.parseInt(AddCatId.getText()));
	...
	private void insertData(Item rc) {
		...
		try {
			...
			Connector.a.connectDB();
			String sql = "Insert into item (par_code, item_name, quantity, discription, sale_price, origen_price, provide_company_name, cat_id) values(?,?,?,?,?,?,?,?)";
