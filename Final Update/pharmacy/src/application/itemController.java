...
public class itemController {
	...
	public void updateExpDate(int parcode, String CompName, int catID, String NewDate) {
		...
		try {
			...
			Connector.a.connectDB();
			Connector.a.ExecuteStatement("update  item set exp_date = '" + sqlDate + "' where par_code = " + parcode
					+ " and provide_company_name = '" + CompName + "' and cat_id = " + catID + ";");
			Connector.a.connectDB().close();
	...
	void FilterCompany(ActionEvent event) {
		...
		String SQL = " SELECT * FROM item WHERE provide_company_name = '" + CompanyText.getText()
				+ "' order by item_name ;";
