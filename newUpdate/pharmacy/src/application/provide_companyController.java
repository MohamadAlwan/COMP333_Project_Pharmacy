...
//			System.out.println("update  employee set employee_name = '" + name + "' where id = " + ID_num);
			...
			Connector.a
					.ExecuteStatement("update  provide_company set address = '" + newValue + "' where company_name = '" + companyName + "';");
...
//			System.out.println("update  employee set employee_name = '" + name + "' where id = " + ID_num);
			Connector.a.connectDB();
			Connector.a
					.ExecuteStatement("update  provide_company set phone = '" + newValue + "' where company_name = '" + companyName + "';");
			Connector.a.connectDB().close();
//			System.out.println("Connection closed");
	...
	private void getData() {
		String SQL = "select * from provide_company";
		try {
			Connector.a.connectDB();
	...
	private void updateName(String companyName, String newValue) {
		...
		try {
			...
			Connector.a.connectDB();
			Connector.a
					.ExecuteStatement("update  provide_company set company_name = '" + newValue + "' where company_name = '" + companyName + "';");
			Connector.a.connectDB().close();
//			System.out.println("Connection closed");
